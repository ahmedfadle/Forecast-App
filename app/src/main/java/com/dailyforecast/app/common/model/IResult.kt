...
sealed class IResult<out T> {
    ...
    data class Success<T>(val data: T,val dataSourseType: DataSourseType) : IResult<T>()
    ...
    companion object {
        ...
        fun <T> success(data: T,dataSource: DataSourseType): IResult<T> = Success(data,dataSource)
